...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-background selection:bg-secondary selection:text-secondary-foreground">
      {/* Left Side - Branding */}
      <div className="hidden md:flex md:w-1/2 bg-secondary p-12 flex-col justify-between text-secondary-foreground relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-secondary/95 via-secondary/40 to-transparent z-10" />
        ...
        <div className="relative z-20 mt-auto space-y-6">
          ...
          <div className="flex items-center justify-between pt-8 border-t border-white/20">
            <p className="text-sm font-medium text-white/80">{t("register.trusted", language)}</p>
        ...
        <div className="w-full max-w-md space-y-8 animate-fade-in-up">
          ...
          <div className="md:hidden flex justify-center mb-8">
            <Link href="/" className="flex flex-col items-center gap-2">
              ...
              <span className="text-xl font-bold text-secondary italic">VaxTrack</span>
            </Link>
          </div>
          ...
          <div className="space-y-2 text-center md:text-left">
            ...
            <p className="text-muted-foreground">{t("register.description", language)}</p>
          </div>
          ...
          <footer className="pt-8 border-t border-border flex flex-col items-center gap-6">
            <p className="text-sm text-muted-foreground text-center">
              ...
              <Link href="/login" className="font-bold text-secondary hover:underline transition-all">
