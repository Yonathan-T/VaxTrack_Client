...
function InventoryLogsContent() {
  ...
  const handleExportLogs = async (format: "pdf" | "csv" | "xlsx") => {
    setIsExporting(true);
    try {
      toast({
        title: language === "am" ? "ወደ ውጭ በመላክ ላይ..." : "Exporting...",
        description:
          language === "am" ? "ሪፖርቱን እያዘጋጀን ነው..." : "Preparing your report...",
      });
      ...
      toast({
        ...
        description:
          language === "am" ? "ሪፖርቱን ማውረድ አልተቻለም" : "Failed to download report",
        variant: "destructive",
      });
    } finally {
          ...
          <div className="flex gap-2">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-56">
                ...
                <DropdownMenuItem onClick={() => handleExportLogs("xlsx")}>
                  <FileSpreadsheet className="mr-2 h-4 w-4" />
                  <span>Excel</span>
                </DropdownMenuItem>
                      ...
                      >
                        ...
                        <td className="py-4 px-4">
                          <div className="font-medium text-foreground">
                            {log.inventory_item?.vaccine?.name ||
                              "Unknown Vaccine"}
                          </div>
                        ...
                        <td className="py-4 px-4">
                          <span
                            className={cn(
                              ...
                              getActionColor(log.type || log.action),
                            )}
                          >
